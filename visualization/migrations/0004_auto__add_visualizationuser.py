...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('visualization_visualizationuser', (
            ('user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], primary_key=True, unique=True)),
            ('uploadedFiles', self.gf('jsonfield.fields.JSONField')()),
        ))
    ...
    models = {
        ...
        'visualization.visualizationuser': {
            'Meta': {'_ormbases': ['auth.User'], 'object_name': 'VisualizationUser'},
            'uploadedFiles': ('jsonfield.fields.JSONField', [], {}),
