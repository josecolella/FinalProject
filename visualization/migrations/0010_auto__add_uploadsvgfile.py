...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UploadSVGFile'
        db.create_table('visualization_uploadsvgfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('visualization', ['UploadSVGFile'])


    def backwards(self, orm):
        # Deleting model 'UploadSVGFile'
        db.delete_table('visualization_uploadsvgfile')
    ...
    models = {
        ...
        'visualization.uploadsvgfile': {
            'Meta': {'object_name': 'UploadSVGFile'},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        'visualization.visualizationmodeldescription': {
            ...
            'link': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True', 'db_index': 'True'}),
